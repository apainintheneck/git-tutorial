...
-->
    ...
    <body class="stac-body">
        <header class="stac-header">
        ...
        <div class="stac-box stac-w4">
            ...
            <b>Note:</b> This tutorial was created using <code class="stac-code">git version 2.24.3</code>.
        </div>
        
        <div class="stac-box stac-w3">
